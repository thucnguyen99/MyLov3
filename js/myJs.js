const textConfig = {
  text1: "Ê Hòi!!",
  text2: "Tôi có điều này muốn hỏi em mà nhớ phải trả lời thật lòng nhaaa.",
  text3: "Em còn yêu tôi",
  text4: "Nếu em không trả lời là vẫn yêu tôi nha",
  text5: "Anh mơ à???",
  text6: "Em yêu anh lắm <3",
  ...
  text12: "Okii lunn <3",
  text13: "Thiệt là hông iu luônnnn :(",
  text14: "Trời đất ơiiiiii !!",
  text15: "Ohmmm, không yêu :)",
...
$(document).ready(function () {  
 ...
 $("#kk").click(function () {
  ...
  Swal.fire({
    ...
    width: 900,
    padding: "3em",
    html: "<input type='text' class='form-control' id='txtRe'  placeholder='Không yêu chút nào luônnn :(('>",
    background: '#fff url("img/input-bg.jpg")',
    backdrop: `
                  rgba(0,0,456,0.4)
                  url("img/khoc.gif")
